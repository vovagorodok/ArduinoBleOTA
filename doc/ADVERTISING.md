...
Advertise in two rx and tx characteristics.  
...
Hardware version is `u8[3]` (major, minor, patch) characteristic in uuid: `dac894e6-35a1-11ef-aba5-0fcd13588409`.  
Software name is `string` characteristic in uuid: `dac895b8-35a1-11ef-aba6-63ebb073a878`.  
Software version is `u8[3]` (major, minor, patch) characteristic in uuid: `dac89694-35a1-11ef-aba7-bf64db99d724`.